...
<div class="mainwrap page-promos promo-page">
	...
	<div class="promos_container">
		<div class="box-nav_container">
			<div class="box-nav">
				<div class="nav-opt nav-active" data-opt="promos">
					<h2>Promos</h2>
				...
				<div class="nav-opt" data-opt="events">
					<h2>Events</h2>
					<div class="img-holder_extend">
						<div class="white">
		...
		<div class="opt-content_container">
			<div class="opt-content  opt-active" id="promos">
			...
			<div class="opt-content" id="events">
				<div class="com-bgline">
					...
					<div class="article-post">
						<div class="article-landing">
							<a href="{{url('/events/'.$event->slug)}}">
								<div class="article-banner">
									<div class="img-holder">
										<img src="{{url('/uploads/promos/'.$event->file)}}" alt="">
									</div>
								</div>
								<article>
									<h3>{{$event->title}}</h3>
