@extends('admin')
@section('title')
    <title>CMS || Our Residence </title>
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Our Residence {{ucfirst(Request::segment(3))}}</h1>
    </div>
</div>
<form id="addForm" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        @if(isset($data))
            <img src="{{url('uploads/our-residence/'.$data->background_img)}}" height="250px" width="300px">
        @endif
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <textarea class="text-content form-control text-content" name="content" rows="7">{{isset($data) ? $data->description : ''}}</textarea> 
